...
class HotelSerializer(serializers.ModelSerializer):
    serializers.DateTimeField(format='%d/%m/%Y %H:%M', read_only=True)
    departure_date = serializers.DateTimeField(format='%d/%m/%Y %H:%M', read_only=True)
    arrival_date = serializers.DateTimeField(format='%d/%m/%Y %H:%M', read_only=True)
    ...
    def to_representation(self, instance):
        ...
        # representation['guesthouse'] = GuestHouseSerializer(instance.apartments.all(), many=True).data
